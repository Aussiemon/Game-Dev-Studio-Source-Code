...
cd.id = "scenario_console_domination"
cd.trackCompletion = true
cd.name = _T("SCENARIO_4_NAME", "Console Domination")
...
cd.achievementOnFinish = achievements.ENUM.CONSOLE_DOMINATION
cd.startingGenres = {
	"action",
	"simulation",
	"strategy"
