rivalGameCompanies.registerNew({
	...
	id = "pay_denbts_1",
	ceoSkillLevels = 60,
	name = _T("RIVAL_COMPANY_PAY_DENBTS_1", "Arx Studios"),
	startingEmployees = {
		{
			repeatFor = 12,
...
rivalGameCompanies.registerNew({
	...
	angerForLegalAction = 50,
	ceoLevel = 4,
	preBankruptBuyoutCostMultiplier = 25,
	...
	id = "pay_denbts_2",
	ceoSkillLevels = 60,
	name = _T("RIVAL_COMPANY_PAY_DENBTS_2", "Mega Blast Games"),
	startingEmployees = {
		{
			repeatFor = 6,
			role = "software_engineer",
...
rivalGameCompanies.registerNew({
	...
	id = "pay_denbts_3",
	ceoSkillLevels = 60,
	name = _T("RIVAL_COMPANY_PAY_DENBTS_3", "Chum Games"),
	startingEmployees = {
		{
			repeatFor = 5,
			role = "software_engineer",
